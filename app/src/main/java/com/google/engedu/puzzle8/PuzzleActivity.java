...
public class PuzzleActivity extends AppCompatActivity {
    ...
    Button btnPic, btnSolve, btnShuffle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPic = (Button) findViewById(R.id.photo_button);
        btnSolve = (Button) findViewById(R.id.solve_button);
        btnShuffle = (Button) findViewById(R.id.shuffle_button);
        ...
        btnPic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dispatchTakePictureIntent(boardView);
            }
        });
    }
